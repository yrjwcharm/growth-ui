...
const Iconbianzu: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
  const style = _style ? { ...DEFAULT_STYLE, ..._style } : DEFAULT_STYLE

  return (
    <svg viewBox="0 0 1024 1024" width={size + 'px'} height={size + 'px'} style={style} {...rest}>
      <path
        d="M512 28.288a409.6 409.6 0 1 1 0 819.2 409.6 409.6 0 0 1 0-819.2z m0 64a345.6 345.6 0 1 0 0 691.2 345.6 345.6 0 0 0 0-691.2zM193.536 942.848c227.328-85.333333 445.312-85.333333 652.373333 0.426667a32 32 0 0 1-24.448 59.093333c-191.744-79.36-392.96-79.36-605.44 0.426667a32 32 0 0 1-22.485333-59.946667z"
